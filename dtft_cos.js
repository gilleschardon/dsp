...
axissig = new Axis("#plotsig", "sig", 600, 300, margins, sigrange, yrangesig, ntickx, nticky)
axisdft = new Axis("#plotdft", "dft", 600, 300, margins, FSrange, yrangedft, ntickx, nticky)
