...
ir = [...Array(Lmax).keys()].map(t => Math.cos(2 * Math.PI * nu0 * t) + 0.005 * Math.cos(2 * Math.PI * nu2 * t))
...
axisgain = new Axis("#plotgain", "gain", 1000, 500, margins2, nurange, Hrange, ntickx, nticky)
